...
export function ChapterGoaTractors() {
  ...
  useGSAP(() => {
    ...
    if (!section) return;
    gsap.from(section.querySelectorAll(".goa-label, .goa-title, .goa-copy, .campaign-card, .result-card, .goa-proof"), { y: 50, opacity: 0, stagger: .1, scrollTrigger: { trigger: section, start: "top 72%", end: "top 28%", scrub: true } });
  ...
  return <section ref={root} className="goa-tractors">
    ...
    <div className="goa-proof-section"><GoaProofOfWork /></div>
