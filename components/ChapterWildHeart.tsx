...
export function ChapterWildHeart() {
  ...
  return <section ref={root} className="wild-heart">
    <div className="wild-grid"><div><span className="wild-label">Chapter 07 / 2026</span><h2 className="wild-title">Understanding<br />People.</h2><p className="wild-copy">For WildHeart Stays, research became the starting point: listen closely, see the patterns, and let real customer expectations shape the strategy.</p></div><div className="survey-card"><span>SURVEY RESPONSES</span><strong>220</strong><div className="chart"><i className="chart-bar" /><i className="chart-bar" /><i className="chart-bar" /><i className="chart-bar" /><i className="chart-bar" /><i className="chart-bar" /></div><small>Customer insight study</small></div></div>
